...
const RequireAuth: React.FC<RequireAuthProps> = ({ children, allowedRoles }) => {
    ...
    if (loading) {
        return (
            <div className="h-screen flex flex-col items-center justify-center bg-brand-light">
                ...
                <p className="mt-4 font-black text-brand-turquoise uppercase tracking-widest text-xs">Verificando Credenciales...</p>
            </div>
        );
    }
    ...
    if (forbidden) {
        return (
            <div className="h-screen bg-brand-light flex items-center justify-center p-4">
